...
/****** Object:  UserDefinedTableType [dbo].[new_tbl_postfall_clinial_monitoring_details_a3_Type]    Script Date: 9/5/2018 10:15:56 PM ******/
CREATE TYPE [dbo].[new_tbl_postfall_clinial_monitoring_details_a3_Type] AS TABLE(
	[linkid] [int] NOT NULL,
	[tableid] [int] NULL,
